...
@section('title', 'Perpustakaan - Member')
@section('content')
    <div class="container-fluid px-4">
        <h1 class="mt-4 mb-3">Member</h1>
        ...
        <div class="card mb-4" style="border: 1px solid #d6caad; border-radius: 10px; overflow: hidden;">
            ...
            <div class="card-header d-flex align-items-center justify-content-between"
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <p class="mb-0" style="color: #f5ece0; font-size: 13px; font-weight: 500;">Data Member</p>
                </div>
                ...
                <table id="datatablesSimple">
                    ...
                    <tbody>
                        @foreach ($members as $member)
                            <tr>
                                <td style="color: #8c7a5e; font-variant-numeric: tabular-nums;">{{ $member->member_code }}
                                </td>
                                <td style="font-weight: 500; color: #2c2416;">{{ $member->name }}</td>
                                <td style="color: #6b5a42;">{{ $member->email }}</td>
                                <td style="color: #6b5a42;">{{ $member->address }}</td>
                                <td style="color: #6b5a42; font-variant-numeric: tabular-nums;">{{ $member->phone }}</td>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        {{-- Edit --}}
