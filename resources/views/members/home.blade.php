...
@section('content')
    <div class="container-fluid px-4">
                            ...
                            <div class="modal-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-7 col-sm-8">
                                        ...
                                        @if ($book->stock == 0)
                                            <button class="btn-borrow btn-borrow-disabled" disabled>Stok Habis</button>
                                        @elseif (in_array($book->id, $userBorrowedBookIds))
                                            <button class="btn-borrow btn-borrow-disabled" disabled>Sudah Dipinjam</button>
                                        @elseif ($borrowCount >= 3)
                                            <button class="btn-borrow btn-borrow-disabled" disabled>Limit Tercapai</button>
                                        @else
                                            <form action="{{ route('borrow.book', $book->id) }}" method="POST">
                                                @csrf
                                                <button type="submit" class="btn-borrow btn-borrow-active">
                                                    <i class="fa-solid fa-bookmark"
                                                        style="font-size:13px; margin-right:6px;"></i>Pinjam Buku
                                                </button>
                                            </form>
                                        @endif
                                    </div>
        ...
        <div id="emptyState" style="display:none; text-align:center; padding:60px 20px; color:#a0693a;">
            <i class="fa-solid fa-book-open" style="font-size:32px; opacity:0.4; margin-bottom:12px; display:cener  ;"></i>
